...
const PANEL_BG = "rgba(12, 24, 18, 0.95)";
    ...
    >
      ...
      <div
        style={{
          ...
          borderTop: "1px solid rgba(45, 122, 58, 0.2)",
          flexShrink: 0,
        }}
      >
        {!isFirstStep && (
        ...
        <button
          ...
          style={{
            ...
            boxShadow: canProceed ? "0 4px 16px rgba(45, 122, 58, 0.3)" : "none",
            transition: "all 0.2s",
          }}
        >
          {isLastStep ? "View Your Bouquet" : "Next"}
        </button>
      </div>
    </div>
  );
