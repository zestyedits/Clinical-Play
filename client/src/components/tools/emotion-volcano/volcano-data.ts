...
export const STEPS: StepDef[] = [
  {
    ...
    icon: "🌋",
    bg: "linear-gradient(170deg, #fff8f5 0%, #fceee8 45%, #f5e4dc 100%)",
    accent: "#e06040",
    glow: "rgba(224,96,64,0.2)",
    floats: ["🌋", "🔥", "💨"],
  },
  {
    ...
    icon: "🫧",
    bg: "linear-gradient(170deg, #fdf8f3 0%, #f5eadc 45%, #ecdfd0 100%)",
    accent: "#d48a40",
    glow: "rgba(212,138,64,0.2)",
    floats: ["🫧", "🌡️", "⚡"],
  },
  {
    ...
    icon: "🚨",
    bg: "linear-gradient(170deg, #fdf6f8 0%, #f8e8ee 45%, #efdce4 100%)",
    accent: "#d45580",
    glow: "rgba(212,85,128,0.18)",
    floats: ["🚨", "🫀", "⚠️"],
  },
  {
    ...
    icon: "❄️",
    bg: "linear-gradient(170deg, #f4f9fc 0%, #e5f0f8 45%, #d9e8f2 100%)",
    accent: "#55a0d8",
    glow: "rgba(85,160,216,0.22)",
    floats: ["❄️", "🌊", "🧊"],
  },
  {
    ...
    icon: "📋",
    bg: "linear-gradient(170deg, #f5faf6 0%, #e8f2ea 45%, #dce8de 100%)",
    accent: "#7cb87c",
    glow: "rgba(124,184,124,0.2)",
    floats: ["📋", "✅", "🛡️"],
  },
  {
    ...
    icon: "🏆",
    bg: "linear-gradient(170deg, #fdfaf3 0%, #f4ead8 45%, #eadfc8 100%)",
    accent: "#d4a853",
