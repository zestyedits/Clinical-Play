      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-md mx-auto pt-32 px-6 text-center">
          <GlassCard className="p-8">
            ...
            <h2 className="text-xl font-serif text-foreground mb-2">Access Restricted</h2>
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto pt-28 md:pt-36 pb-16 px-6">
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl font-serif text-foreground" data-testid="text-admin-title">Admin</h1>
          <p className="text-sm text-muted-foreground mt-1">Manage users, waitlist, and announcements</p>
        </div>

        <div className="flex gap-1 mb-8 bg-secondary rounded-full p-1 border border-border w-fit overflow-x-auto">
          {tabs.map((tab) => (
            <button
              key={tab.id}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <span className="text-sm font-medium text-foreground truncate" data-testid={`text-user-email-${u.id}`}>
                            {u.email || "No email"}
                          </span>
                          {u.isPro && (
                ...
                <motion.div key={entry.id} initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }}>
                  <GlassCard className="p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <span className="text-sm font-medium text-foreground" data-testid={`text-waitlist-email-${entry.id}`}>{entry.email}</span>
                        <p className="text-xs text-muted-foreground">
        ...
        {activeTab === "announce" && (
          <GlassCard className="p-6 md:p-8">
            <h3 className="text-lg font-serif text-foreground mb-1">Send Announcement</h3>
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 px-4 rounded-xl bg-secondary border border-border text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/30"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full px-4 py-3 rounded-xl bg-secondary border border-border text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/30 resize-none"
