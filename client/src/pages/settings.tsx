...
const SECTIONS = [
  ...
  { id: "sessions", label: "Session Defaults", icon: Play },
...
export default function SettingsPage() {
  ...
  const scrollToSection = useCallback((id: string) => {
    ...
    if (tabsRef.current) {
      const activeTab = tabsRef.current.querySelector(`[data-section="${id}"]`);
      if (activeTab) {
          ...
          <main className="flex-1 min-w-0 space-y-10" ref={scrollContainerRef}>
            ...
            >
              <div className="mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 shadow-sm bg-gradient-to-br from-primary/15 to-primary/5">
                    <User size={20} strokeWidth={1.8} className="text-primary" />
                  </div>
                  <div>
                    <h2 className="text-lg md:text-xl font-serif text-foreground tracking-tight">Profile</h2>
                    <p className="text-[11px] text-muted-foreground/70 mt-0.5">Personal information & contact details</p>
                  </div>
                </div>
            ...
            >
              <div className="mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 shadow-sm bg-gradient-to-br from-primary/15 to-primary/5">
                    <Briefcase size={20} strokeWidth={1.8} className="text-primary" />
                  </div>
                  <div>
                    <h2 className="text-lg md:text-xl font-serif text-foreground tracking-tight">Professional</h2>
                    <p className="text-[11px] text-muted-foreground/70 mt-0.5">Credentials, modalities & populations</p>
                  </div>
                </div>
                <div className="mt-5 h-px bg-gradient-to-r from-border/60 via-border/30 to-transparent" />
              </div>
            ...
            >
              <div className="mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 shadow-sm bg-gradient-to-br from-accent/15 to-accent/5">
                    <Palette size={20} strokeWidth={1.8} className="text-accent" />
                  </div>
                  <div>
                    <h2 className="text-lg md:text-xl font-serif text-foreground tracking-tight">Appearance</h2>
                    <p className="text-[11px] text-muted-foreground/70 mt-0.5">Theme, style & display preferences</p>
                  </div>
                </div>
                <div className="mt-5 h-px bg-gradient-to-r from-border/60 via-border/30 to-transparent" />
              </div>
            ...
            >
              <div className="mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 shadow-sm bg-gradient-to-br from-purple-500/15 to-purple-500/5">
                    <Play size={20} strokeWidth={1.8} className="text-purple-600" />
                  </div>
                  <div>
                    <h2 className="text-lg md:text-xl font-serif text-foreground tracking-tight">Session Defaults</h2>
                    <p className="text-[11px] text-muted-foreground/70 mt-0.5">Default session behavior & preferences</p>
                  </div>
                </div>
                <div className="mt-5 h-px bg-gradient-to-r from-border/60 via-border/30 to-transparent" />
              </div>
            ...
            >
              <div className="mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 shadow-sm bg-gradient-to-br from-amber-500/15 to-amber-500/5">
                    <Crown size={20} strokeWidth={1.8} className="text-amber-600" />
                  </div>
                  <div>
                    <h2 className="text-lg md:text-xl font-serif text-foreground tracking-tight">Plan & Billing</h2>
                    <p className="text-[11px] text-muted-foreground/70 mt-0.5">Subscription, payment method & invoices</p>
                  </div>
                </div>
                <div className="mt-5 h-px bg-gradient-to-r from-border/60 via-border/30 to-transparent" />
              </div>
            ...
            >
              <div className="mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 shadow-sm bg-gradient-to-br from-blue-500/15 to-blue-500/5">
                    <Users size={20} strokeWidth={1.8} className="text-blue-600" />
                  </div>
                  <div>
                    <h2 className="text-lg md:text-xl font-serif text-foreground tracking-tight">Team</h2>
                    <p className="text-[11px] text-muted-foreground/70 mt-0.5">Organization members & invitations</p>
                  </div>
                </div>
                <div className="mt-5 h-px bg-gradient-to-r from-border/60 via-border/30 to-transparent" />
              </div>
            ...
            >
              <div className="mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 shadow-sm bg-gradient-to-br from-emerald-500/15 to-emerald-500/5">
                    <Shield size={20} strokeWidth={1.8} className="text-emerald-600" />
                  </div>
                  <div>
                    <h2 className="text-lg md:text-xl font-serif text-foreground tracking-tight">Security</h2>
                    <p className="text-[11px] text-muted-foreground/70 mt-0.5">Password, two-factor & active devices</p>
                  </div>
                </div>
                <div className="mt-5 h-px bg-gradient-to-r from-border/60 via-border/30 to-transparent" />
              </div>
            ...
            >
              <div className="mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 shadow-sm bg-gradient-to-br from-rose-500/15 to-rose-500/5">
                    <Lock size={20} strokeWidth={1.8} className="text-rose-500" />
                  </div>
                  <div>
                    <h2 className="text-lg md:text-xl font-serif text-foreground tracking-tight">Data & Privacy</h2>
                    <p className="text-[11px] text-muted-foreground/70 mt-0.5">PHI policy, data export & account deletion</p>
                  </div>
                </div>
                <div className="mt-5 h-px bg-gradient-to-r from-border/60 via-border/30 to-transparent" />
              </div>
