            ...
            {DEMO_TABS.map((tab) => {
              ...
              return (
                <motion.button
                  ...
                  style={{
                    background: isActive ? `${tab.color}18` : "rgba(0,0,0,0.03)",
                    color: isActive ? tab.color : "#A89880",
                    border: `1.5px solid ${isActive ? `${tab.color}40` : "rgba(0,0,0,0.06)"}`,
                    boxShadow: isActive ? `0 8px 24px -8px ${tab.color}40, inset 0 1px 0 rgba(255,255,255,0.35)` : "0 2px 8px -4px rgba(0,0,0,0.06)",
                  }}
