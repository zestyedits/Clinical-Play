...
export const TOOLS_LIBRARY: ToolDefinition[] = [
  ...
  },
  {
    id: "parts-theater",
    name: "Parts Theater",
    shortDescription: "IFS-inspired role exploration and dialogue",
    longDescription: "A stage-like space where clients create, name, and arrange their internal 'parts' — protectors, exiles, managers, and Self. Parts can be given voice through text bubbles and positioned in relation to each other.",
    icon: "🎭",
