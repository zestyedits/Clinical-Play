...
export const TOOLS_LIBRARY: ToolDefinition[] = [
  ...
  {
    id: "thought-sieve",
    name: "The Thought Sieve",
    shortDescription: "Sort sticky thoughts from flowing ones to externalize obsessive patterns",
    longDescription: "A sorting tool where clients separate 'Sticky Thoughts' (obsessions, ruminations, intrusive patterns) from 'Flowing Thoughts' (passing ideas, observations). Helps externalize and categorize thought patterns to reduce their hold.",
    icon: "🧪",
    modalities: ["CBT", "ACT", "Mindfulness", "Psychoeducation"],
    ageRanges: ["Teens (14-18)", "Young Adults (18-25)", "Adults (25-64)"],
    intensity: "moderate",
    duration: "15-25",
    ...
    tier: "free",
    bestUsedFor: [
      "Externalizing obsessive or ruminative thought patterns",
      "Teaching cognitive defusion (ACT)",
      "Distinguishing between productive worry and unhelpful loops",
      "Building metacognitive awareness of thought quality",
    ],
    adaptations: "For teens, use relatable language — 'brain glue' for sticky thoughts. For OCD clients, frame as an observation exercise, not a suppression tool.",
    pitfalls: "Don't imply sticky thoughts are 'bad' — they're data about what the brain is protecting. The sieve is for noticing, not judging.",
    safetyNotes: "If intrusive thoughts involve self-harm, pause the exercise and assess safety directly.",
    producesArtifact: true,
    lastUsed: null,
    timesUsed: 0,
  },
  {
    ...
    shortDescription: "Topographic body-map to track somatic sensations and feeling locations",
    longDescription: "A topographic view of the body where clients place emotion markers to track where they physically experience feelings. Maps the somatic landscape of emotional experience to build interoceptive awareness.",
    icon: "🗺️",
    modalities: ["Somatic", "EMDR", "DBT", "Mindfulness"],
    ...
    tier: "free",
    bestUsedFor: [
      "Building interoceptive awareness for alexithymic clients",
      "Tracking somatic patterns across sessions",
      "EMDR body scan preparation",
      "Grounding through body-based check-ins",
    ],
    adaptations: "For children, simplify to 'where does it live in your body?' For trauma survivors, offer choice of detail level — outline only vs detailed body.",
    pitfalls: "Some clients dissociate when focusing on body sensations. Watch for freeze responses. Offer eyes-open option.",
    safetyNotes: "Clinician controls pacing. If body focus triggers distress, return to breathing or external anchoring.",
    producesArtifact: true,
    lastUsed: null,
    timesUsed: 0,
  },
  {
    ...
    shortDescription: "Drag-and-drop deck to identify core pillars when feeling lost",
    longDescription: "A drag-and-drop card sorting exercise where clients sort value cards into priority tiers to clarify what matters most. Designed for moments of identity confusion, transition, or values-behavior gaps.",
    icon: "🃏",
    ...
    bestUsedFor: [
      ...
      "Career and life transition work",
      "Identifying values-behavior gaps",
    ],
    adaptations: "For teens, reduce the deck size. For crisis moments, focus on 'What matters right now?' rather than a full sort.",
    pitfalls: "If everything is 'Very Important,' reflect that — it's data about overwhelm, not failure to sort.",
    safetyNotes: "No sensitive data captured unless exported. Cards can be cleared and re-sorted freely.",
    producesArtifact: true,
    lastUsed: null,
    timesUsed: 0,
  },
  {
    ...
    shortDescription: "Plot life events on a scrolling timeline to re-story and process trauma",
    longDescription: "A scrolling timeline where clients place symbolic markers for significant life events. Supports narrative re-authoring by allowing reframing, reordering, and annotating the story of their experience.",
    icon: "🌊",
    ...
    adaptations: "For adolescents, focus on recent events. For trauma work, give the client control over detail level — a marker labeled 'hard year' is enough.",
    pitfalls: "Can open emotional floodgates if used without pacing. Don't complete a full life timeline in one session. Watch for dissociation.",
    safetyNotes: "Consider using breathing tools before and after. Frame the exit: 'We can come back to this.'",
    producesArtifact: true,
    lastUsed: null,
    timesUsed: 0,
  },
