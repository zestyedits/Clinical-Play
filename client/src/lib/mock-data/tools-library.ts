...
export const TOOLS_LIBRARY: ToolDefinition[] = [
  ...
  {
    id: "mi-motivation-garden",
    name: "The Motivation Garden",
    shortDescription: "Grow your motivation for change using seeds, water, and a commitment bouquet",
    longDescription: "A rich Motivational Interviewing tool using the garden metaphor. Clients select a change topic, then plant DARN seeds (Desire, Ability, Reason, Need) representing change talk. They identify sustain talk as weeds (Same, Self, Situation, Solve), rate importance and confidence using readiness rulers, connect to personal values, and finally harvest a commitment bouquet. Features 7 steps including a guided growing moment for mindful reflection, and a comprehensive harvest summary with all seeds, weeds, ratings, and commitments visualized.",
    icon: "🌱",
    accentColor: "#2d7a3a",
    category: "game",
    modalities: ["Motivational Interviewing", "CBT", "ACT", "Psychoeducation"],
    ...
    tier: "free",
    bestUsedFor: [
      "Exploring ambivalence about change in a structured, visual way",
      "Evoking and strengthening change talk using the DARN framework",
      "Identifying and gently challenging sustain talk without confrontation",
      "Building intrinsic motivation by connecting change to personal values",
      "Creating concrete commitment plans with the bouquet harvest",
    ],
    adaptations: "For teens, the garden metaphor feels natural and less clinical than traditional MI exercises. For adults, frame as 'mapping your motivation landscape.' The DARN framework is scaffolded with examples per category. The weed metaphor normalizes ambivalence rather than pathologizing it.",
    pitfalls: "Don't force clients to 'pull weeds' — sustain talk is valid and serves a protective function. The readiness rulers can feel reductive if not explored dialogically. The bouquet step pushes toward commitment — ensure the client is ready and not just performing. Leave space for ambivalence at every step.",
    safetyNotes: "When exploring reasons for change, clients may disclose consequences of harmful behaviors (substance use, self-harm, disordered eating). Be prepared to hold space for these disclosures. The tool is not appropriate for mandated change situations where autonomy feels violated — MI requires voluntary engagement.",
    producesArtifact: true,
    lastUsed: null,
    timesUsed: 0,
  },
  ...
  {
    id: "emotion-volcano",
    name: "The Emotion Volcano",
    shortDescription: "Explore anger triggers, map body warning signs, and build a cooling plan",
    longDescription: "A comprehensive anger management and emotional regulation tool using the volcano metaphor. Clients set their emotional baseline, identify triggers that fill the volcano with 'lava' (watching it rise in real-time), map physical warning signs on an interactive body silhouette, discover and apply evidence-based cooling techniques (watching the temperature drop), and construct a personalized 3-tier eruption prevention plan. Features 14 cooling techniques across instant, short, and extended tiers, a detailed body map with 10 regions and sensation tracking, and a comprehensive summary report with before/after volcano visualization. Supports child, teen, and adult language modes.",
    icon: "\u{1F30B}",
    accentColor: "#e06040",
    category: "game",
    modalities: ["DBT", "CBT", "Psychoeducation", "Somatic", "Mindfulness"],
    ageRanges: ["Children (5-11)", "Tweens (11-14)", "Teens (14-18)", "Young Adults (18-25)", "Adults (25-64)"],
    intensity: "moderate",
    duration: "20-45",
    interactionType: "cognitive",
    ...
    tier: "free",
    bestUsedFor: [
      "Teaching anger management and emotional regulation skills",
      "Helping clients identify their personal anger triggers and patterns",
      "Building somatic awareness of anger's physical warning signs",
      "Creating personalized cooling strategies and prevention plans",
      "Psychoeducation about the anger escalation cycle using the volcano metaphor",
      "Working with clients who struggle with explosive anger or emotional dysregulation",
    ],
    adaptations: "For children (6-10), the tool uses playful language ('cooling superpowers,' 'alarm bells') and simplified metaphors. For teens, language is relatable and validates their experience. For adults, clinical depth is added with references to the autonomic nervous system, amygdala hijack, and evidence-based techniques like opposite action from DBT. The body map works across all age ranges with age-appropriate sensation descriptions.",
    pitfalls: "Don't treat the temperature slider as a literal measure — it's a metaphor for subjective experience. Some clients may minimize their baseline to appear 'fine.' If a client fills many high-intensity triggers, check in about safety before proceeding to cooling techniques. The gamified cooling animation can feel dismissive to clients in acute distress — use clinical judgment about timing.",
    safetyNotes: "Exploring anger triggers can itself be activating. Monitor the client's real-time emotional state, not just the in-game temperature. If a client identifies physical warning signs related to self-harm (e.g., 'urge to hit myself'), redirect to safety planning. The cooling techniques include physical activities (cold water, exercise) — assess appropriateness for the clinical setting. The tool produces a summary that can serve as a take-home resource.",
    producesArtifact: true,
    lastUsed: null,
    timesUsed: 0,
  },
